...
{
	console.log("Update RadioID:",radioID,document.getElementById("radioName"+radioID).value, document.getElementById("radioUri"+radioID).value,document.getElementById("radioIP"+radioID).value,document.getElementById("sipPort"+radioID).value);
	var trxMode = "";
	if (document.getElementById("nodetype"+radioID).value == 1) trxMode = "TRx";
	else if (document.getElementById("nodetype"+radioID).value == 2) trxMode = "Tx";
	else if (document.getElementById("nodetype"+radioID).value == 3) trxMode = "Rx";
	else
	{
		location.reload();
		return;
	}
	if (document.getElementById("radioName"+radioID).value == "") return;
	if (document.getElementById("radioUri"+radioID).value == "") return;
	if (document.getElementById("sipPort"+radioID).value == "") return;
	
	var jsonMessage = '{"menuID":"updateRadio",'
					+'"radioName":"' + document.getElementById("radioName"+radioID).value + '",'
					+'"trxMode":"' + trxMode + '",'
					+'"uri":"' + document.getElementById("radioUri"+radioID).value + '",'
					+'"ipAddress":"' + document.getElementById("radioIP"+radioID).value + '",'
					+'"r2sPeroid":' + '200' + ','
					+'"sipPort":' + document.getElementById("sipPort"+radioID).value + ','
					+'"frequency":"' + '0' + '",'
					+'"radioID":' + radioID + ''
					+'}';
	if (ws.readyState == 1){
...
function newRadio()
{
	console.log("New RadioID:",document.getElementById("radioName").value, document.getElementById("radioUri").value,document.getElementById("radioIP").value,document.getElementById("sipPort").value);
	var trxMode = "";
